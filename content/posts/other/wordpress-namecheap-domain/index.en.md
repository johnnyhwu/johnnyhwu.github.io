...
{{< image src="lightsail-dns-setting.png" caption="Click on Domains & DNS in the Lightsail sidebar" >}}
...
{{< image src="lightsail-domain.png" caption="Create a DNS Zone and enter your domain" >}}

After creating the DNS Zone, click the "Assignments" tab, and then click "Add assignment":

{{< image src="lightsail-domain-assign.png" caption="Select the Assignments tab" >}}
...
{{< image src="lightsail-static-ip.png" caption="Assign the current domain to the server's static IP" >}}
...
{{< image src="lightsail-dns-setting-2.png" caption="A new A record can be seen in the DNS records tab" >}}
...
{{< image src="lightsail-nameerver.png" caption="Go back to the Domains tab and note the Name Servers section" >}}

Next, in Namecheap's left sidebar menu, select "Domain List" and click "MANAGE" next to your domain:

{{< image src="namecheap-domain-list.png" caption="Go to Namecheap, click on 'Domain List' in the sidebar, and then click 'Manage' next to your domain" >}}

In the Name Servers section, select "Custom DNS" and paste the four AWS Name Server addresses you found in Lightsail:

{{< image src="namecheap-settings.png" caption="Paste the four Name Server addresses from Lightsail one by one into the Custom DNS fields" >}}
...
{{< image src="dns-checker.png" caption="Check the DNS record propagation status using DNS Checker" >}}
...
{{< image src="wordpress-domain-setting.png" caption="In the WordPress dashboard, change the 'WordPress Address' and 'Site Address' to the correct domain" >}}
