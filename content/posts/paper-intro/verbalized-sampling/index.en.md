...
{{< image src="table4.png" caption="Performance of a model fine-tuned on math synthetic data generated using VS. The baseline is fine-tuning directly with 1K data. It can be seen that VS-Multi (37.5%) achieved a significant accuracy improvement compared to Direct Prompting (30.6%)." >}}
