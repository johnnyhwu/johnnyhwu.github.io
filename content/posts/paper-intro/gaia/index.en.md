...
{{< image src="author.png" caption="The authors of GAIA" >}}
...
{{< image src="llama3.png" caption="Benchmarks used for Llama-3" >}}
...
{{< image src="file-type.png" caption="File types included in the GAIA Benchmark" >}}
...
{{< image src="difficulty.png" caption="Question difficulty in the GAIA Benchmark" >}}
...
{{< image src="exp.png" caption="Performance of multiple SOTA LLMs on the GAIA Benchmark" >}}
