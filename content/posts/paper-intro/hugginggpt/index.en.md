...
lastmod: 2025-01-27
draft: false
description: "Dive into the HuggingGPT paper, a key work on LLM Agents. Discover how an LLM acts as a controller for task planning and tool usage to solve multi-modal and complex AI challenges."
...
If you're curious how this single-Controller idea evolved over the following two years, [OctoTools](../octo-tools/) and [Plan-and-Act](../plan-and-act/) are great next reads — they build on the same Task Planning + Tool Execution philosophy but split the Controller into a dedicated Planner-Executor architecture.