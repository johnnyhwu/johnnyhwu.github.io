...
The experimental data in Table 1 is quite surprising. Mem0 not only achieved State-of-the-Art (SOTA) performance in Single-Hop, Multi-Hop, and Temporal categories but also surpassed the second-best method significantly across all three metrics, including baselines like [MemGPT](../memgpt/). In the Open-domain category, while not SOTA, it was only slightly behind the top performer.
